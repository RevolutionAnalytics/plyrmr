...
* prettier default names for new columns, try `transmute(mtcars, carb/cyl)`
...
* operations also encapsulate information about being able to deal with multiple groups at once for better vectorization in the reduce phase, but this is still work in progress.
